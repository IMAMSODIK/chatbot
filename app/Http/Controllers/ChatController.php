    ...
    public function send(Request $request)
    {
        if ($request->type == 'Tanya Jawab') {
            ...
            $prompt = "Gunakan informasi berikut untuk menjawab pertanyaan.\n\n"
                . "Context:\n$context\n\n"
                . "Pertanyaan: $query\n\n"
                . "Format jawaban: Sebutkan dokumen dan halaman yang relevan, misal menurut dokumen A halaman xx dijelaskan... juga berikan jawaban dalam format HTML dalam bentuk poin-poin karena saya ingin menampilkannya di richtext, dan tanpa ada ```html```.\n"
                . "Jawaban:";
