...
@section('content')
            ...
            <div class="page-title">
                <div class="row mt-4">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <button class="btn btn-success" id="tambah-data">Tambah Dokumen</button>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table class="display" id="basic-1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-size: 18px" class="text-center">Nama File</th>
                                            <th style="font-size: 18px" class="text-center">Dokumen</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td style="font-size: 18px">{{ $d->title }}</td>
                                                <td style="font-size: 18px">
                                                    <button class="btn btn-info lihat-file"
                                                        data-file="{{ $d->file_path }}">Lihat File</button>
                                                </td>
                        ...
                        <form class="form theme-form dark-inputs">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            <label class="form-label" for="file_path">Masukkan Dokumen</label>
                                            <input type="file" class="form-control input-air-primary" id="file_path"
    ...
    <div class="modal fade" id="identitasModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Detail File</h5>
...
@section('own_script')
    <script src="{{ asset('own_assets/scripts/dokumen.js') }}"></script>
@endsection
